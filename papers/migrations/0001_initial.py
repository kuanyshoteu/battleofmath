    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='subscribe_payments', to='papers.module')),
            ],
            options={
                'ordering': ['-timestamp'],
            },
        ...
        migrations.AddField(
            model_name='module',
            name='topics',
            field=models.ManyToManyField(related_name='lessons', to='papers.Topic'),
        ),
        migrations.AddField(
            model_name='module',
            name='try_by',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lesson', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='papers.module')),
