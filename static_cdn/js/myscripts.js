    ...
    $(".switch_att_btn").click(function (event) {
        ...
        for(var i = 0; i < document.getElementsByClassName('switch_att_btn' + module_id).length; i++){
            document.getElementsByClassName('switch_att_btn' + module_id)[i].setAttribute('class', 'switch_att_btn switch_att_btn' + module_id)    
        }
        for(var i = 0; i < document.getElementsByClassName('ppr' + module_id).length; i++){
            document.getElementsByClassName('ppr' + module_id)[i].setAttribute('class', 'topic ppr ppr' + module_id)
        }
    ...
    $(".open_form_topic").click(function (event) {
        event.preventDefault();
        $(".create_topic").fadeToggle();
    })
